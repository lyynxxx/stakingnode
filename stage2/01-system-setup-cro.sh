...
## nftables config
mv /tmp/kickstart/eth2nodes/opensuse/etc/sysconfig/nftables-cro.conf /etc/sysconfig/nftables.conf
...
mv /tmp/kickstart/eth2nodes/opensuse/root/.profile-cro /root/.profile
