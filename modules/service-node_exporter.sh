...
cd /opt/tmp
curl -LOk https://github.com/prometheus/node_exporter/releases/download/v1.3.1/node_exporter-1.3.1.linux-amd64.tar.gz
tar -xf node_exporter-1.3.1.linux-amd64.tar.gz
cp /opt/tmp/node_exporter-1.3.1.linux-amd64/node_exporter /usr/local/bin/
...
mv /tmp/kickstart/stakingnode/os/openSUSE/etc/systemd/system/node_exporter.service /etc/systemd/system/node_exporter.service
