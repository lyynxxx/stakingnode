...
cd /opt/prometheus
curl -LOk https://github.com/prometheus/prometheus/releases/download/v2.32.1/prometheus-2.32.1.linux-amd64.tar.gz
...
chown -R prometheus:prometheus /opt/prometheus
rm -rf /opt/prometheus-2.32.1.linux-amd64*

mv /tmp/kickstart/stakingnode/os/openSUSE/etc/prometheus/prometheus.yml /etc/prometheus/prometheus.yml
chown prometheus:prometheus /etc/prometheus/prometheus.yml
chmod 600 /etc/prometheus/prometheus.yml

mv /tmp/kickstart/stakingnode/os/openSUSE/etc/systemd/system/prometheus.service /etc/systemd/system/
